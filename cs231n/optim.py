...
def adam(x, dx, config=None):
    ...
    v = config['beta1'] * config['v'] + (1 - config['beta1']) * dx
    m = config['beta2'] * config['m'] + (1 - config['beta2']) * dx * dx
    first_unbias = v / (1 - config['beta1'] ** config['t'])
    second_unbias = m / (1 - config['beta2'] ** config['t'])
